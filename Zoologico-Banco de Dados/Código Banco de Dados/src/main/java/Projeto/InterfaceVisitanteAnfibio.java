...
public class InterfaceVisitanteAnfibio extends javax.swing.JFrame {
    private static final long serialVersionUID = 2L;
    public InterfaceVisitanteAnfibio() {
        initComponents();
        conectarTabela();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID do Animal", "Nome", "Idade", "Peso", "Altura", "Especie", "Sexo", "Carnivoro", "Herbivoro", "ID do Habitat", "Patas", "Tem Metamorfose"
            }
        ));
        ...
        AnfibiosTexto.setFont(new java.awt.Font("Segoe UI", 1, 48)); // NOI18N
        AnfibiosTexto.setText("Anfíbios");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(388, 388, 388)
                        .addComponent(AnfibiosTexto, javax.swing.GroupLayout.PREFERRED_SIZE, 198, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(458, 458, 458)
    ...
    public void conectarTabela(){
        ...
        try {
            ...
            String sql = "SELECT Animal.AnimalId, "
                    ...
                    + "Animal.HabitatId, "
                    + "Anfibio.AnfibioPatas, "
                    + "Anfibio.AnfibioMetamorfose "
                    + "FROM Animal "
                    + "INNER JOIN Anfibio ON Animal.AnimalId = Anfibio.AnimalId AND Animal.HabitatId = Anfibio.HabitatId ORDER BY AnimalId";
            ...
            while(rs.next()){
                ...
                String patas = String.valueOf(rs.getInt("anfibiopatas"));
                String metamorfose = String.valueOf(rs.getBoolean("anfibiometamorfose"));
                
                String tbData[] = {id, nome, idade, peso, altura, especie, sexo, carnivoro, herbivoro, habitatid, patas, metamorfose};
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(InterfaceVisitanteAnfibio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfaceVisitanteAnfibio().setVisible(true);
            }
        });
    }
