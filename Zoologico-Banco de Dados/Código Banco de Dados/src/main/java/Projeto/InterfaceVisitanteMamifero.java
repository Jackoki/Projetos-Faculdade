...
public class InterfaceVisitanteMamifero extends javax.swing.JFrame {
    private static final long serialVersionUID = 2L;
    public InterfaceVisitanteMamifero() {
        initComponents();
        conectarTabela();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID do Animal", "Nome", "Idade", "Peso", "Altura", "Especie", "Sexo", "Carnivoro", "Herbivoro", "ID do Habitat", "Patas", "Tempo Gestação", "Animal Caminha?"
            }
        ));
        ...
        AnfibiosTexto.setText("Mamíferos ");
    ...
    public void conectarTabela(){
        ...
        try {
            ...
            String sql = "SELECT Animal.AnimalId, "
                    ...
                    + "Animal.HabitatId, "
                    + "Mamifero.MamiferoPatas, "
                    + "Mamifero.MamiferoTempoGestacao, "
                    + "Mamifero.MamiferoCaminha "
                    + "FROM Animal "
                    + "INNER JOIN Mamifero ON Animal.AnimalId = Mamifero.AnimalId AND Animal.HabitatId = Mamifero.HabitatId;";
            ...
            while(rs.next()){
                ...
                String patas = String.valueOf(rs.getInt("mamiferopatas"));
                String tempogestacao = String.valueOf(rs.getInt("mamiferotempogestacao"));
                String caminha = String.valueOf(rs.getBoolean("mamiferocaminha"));
                
                String tbData[] = {id, nome, idade, peso, altura, especie, sexo, carnivoro, herbivoro, habitatid, patas, tempogestacao, caminha};
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(InterfaceVisitanteMamifero.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfaceVisitanteMamifero().setVisible(true);
            }
        });
    }
