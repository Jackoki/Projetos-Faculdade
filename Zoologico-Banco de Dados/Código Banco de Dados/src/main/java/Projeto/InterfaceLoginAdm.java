...
public class InterfaceLoginAdm extends javax.swing.JFrame {
    private static final long serialVersionUID = 2L;
    public InterfaceLoginAdm() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        LoginTexto.setText("Nome do ADM");

        SenhaTexto.setText("Senha do ADM");
    ...
    public void fechar(){
        this.setVisible(false);
        InterfaceOpcaoAdm ina = new InterfaceOpcaoAdm();
        ina.setVisible(true);
    }
    ...
    public void logar(){
        ...
        if (nome.equals("administrador") && senha.equals("administrador")) {
            fechar();
        } 
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(InterfaceLoginAdm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfaceLoginAdm().setVisible(true);
            }
        });
    }
