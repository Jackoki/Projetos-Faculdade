...
public class InterfaceVisitanteReptil extends javax.swing.JFrame {
    private static final long serialVersionUID = 2L;
    public InterfaceVisitanteReptil() {
        initComponents();
        conectarTabela();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID do Animal", "Nome", "Idade", "Peso", "Altura", "Especie", "Sexo", "Carnivoro", "Herbivoro", "ID do Habitat", "Patas", "Tem Veneno"
            }
        ));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(395, 395, 395)
                        .addComponent(AnfibiosTexto, javax.swing.GroupLayout.PREFERRED_SIZE, 178, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    public void conectarTabela(){
        ...
        try {
            ...
            String sql = "SELECT Animal.AnimalId, "
                    ...
                    + "Reptil.ReptilVeneno "
                    + "FROM Animal "
                    + "INNER JOIN Reptil ON Animal.AnimalId = Reptil.AnimalId AND Animal.HabitatId = Reptil.HabitatId";
            ...
            while(rs.next()){
                ...
                String patas = String.valueOf(rs.getInt("reptilpatas"));
                String veneno = String.valueOf(rs.getBoolean("reptilveneno"));
                
                String tbData[] = {id, nome, idade, peso, altura, especie, sexo, carnivoro, herbivoro, habitatid, patas, veneno};
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfaceVisitanteReptil.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfaceVisitanteReptil().setVisible(true);
            }
        });
    }
