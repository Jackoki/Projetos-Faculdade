...
public class InterfaceAtu extends javax.swing.JFrame {
    
    private static InterfaceAtu insUnic;
    
    private InterfaceAtuAnfibio interAnf;
    private InterfaceAtuAve interAve;
    private InterfaceAtuMamifero interMam;
    private InterfaceAtuPeixe interPei;
    private InterfaceAtuReptil interRep;
    ...
    //Singleton
    public static InterfaceAtu geraIntAtu(){
        if(insUnic == null){
            insUnic = new InterfaceAtu();
        }
        return insUnic;
    }
    ...
    //Singleton
    public InterfaceAtuAnfibio geraAtuAnfibio() {
            interAnf = InterfaceAtuAnfibio.geraAtuAnfibio();
    ...
    //Singleton
    public InterfaceAtuAve geraAtuAve() {
            interAve = InterfaceAtuAve.geraAtuAve();
    ...
    //Singleton
    public InterfaceAtuMamifero geraAtuMamifero() {
            interMam = InterfaceAtuMamifero.geraAtuMamifero();
    ...
    //Singleton
    public InterfaceAtuPeixe geraAtuPeixe() {
            interPei = InterfaceAtuPeixe.geraAtuPeixe();
   ...
   //Singleton
    public InterfaceAtuReptil geraAtuReptil() {
            interRep = InterfaceAtuReptil.geraAtuReptil();
