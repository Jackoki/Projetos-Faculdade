...
public class InterfaceAtuAve extends javax.swing.JFrame {
    private Ave ave = new Ave();
    private static InterfaceAtuAve insUnic;
    
    private GerAni ga = GerAni.geraGerAni();
    
    public InterfaceAtuAve() {
        initComponents();
    }
    
    //Singleton
    public static InterfaceAtuAve geraAtuAve(){
        if(insUnic == null){
            insUnic = new InterfaceAtuAve();
        }
        return insUnic;
    }
    ...
    public void atualizar(){   
        try {
            ave.setIdade(getIdade());
            
            ave.setPeso(getPeso()); 
            
            ave.setAltura(getAltura());
            
            ave.setEspecie(getEspecie());
            
            ave.setSexo(getSexo()); 
            
            ave.setHerbivoro(getHerbivoro());
            
            ave.setCarnivoro(getCarnivoro());
            
            ave.setHabitatNomeHab(getNomeHabitat());
                    
            ave.setHabitatTemperatura(getTemperatura());
                                        
            ave.setHabitatArea(getArea());
                                                            
            ave.setHabitatSolo(getSolo());
            
            ave.setAsas(getAsas());
            
            ave.setPatas(getPatas());
    ...
    public int getAsas() {
        return Integer.parseInt(AsasCampo.getText().trim());
    }
    
    public int getVooMax() {
        return Integer.parseInt(VooMaxCampo.getText().trim());
    }
    ...
    private void initComponents() {
        ...
        VooMaxTexto.setText("Altura de Voo Máxima");

        VooMaxCampo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                VooMaxCampoActionPerformed(evt);
            }
        });
        ...
        VooOpcao.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                VooOpcaoActionPerformed(evt);
            }
        });
    ...
    private void VooOpcaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_VooOpcaoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_VooOpcaoActionPerformed
    ...
    private void VooMaxCampoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_VooMaxCampoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_VooMaxCampoActionPerformed
